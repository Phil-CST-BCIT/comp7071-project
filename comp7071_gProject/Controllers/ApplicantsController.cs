...
namespace comp7071_gProject.Controllers
{
    public class ApplicantsController : Controller
    {
        ...
        public ApplicantsController(Comp7071ProjectContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Applicants != null ? 
                          ...
                          Problem("Entity set 'Comp7071ProjectContext.Applicants'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Comp7071ProjectContext.Applicants'  is null.");
            }
            var applicant = await _context.Applicants.FindAsync(id);
            if (applicant != null)
            {
